...
app.post("/profile", (request, response) => {
  ...
  const insertQuery =
    "INSERT INTO profile (name, age, gender, city, mobile, email, username, password) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
...
app.get("/profile", (request, response) => {
  ...
  const selectQuery =
    "SELECT profileId, name, age, gender, city, mobile, email, username, password from profile";
    ...
    if (err) {
      ...
      const profileInputs = profileList.map((singleProfile) => {
        ...
        return {
          ...
          password: singleProfile.password,
        };
      });
...
app.post("/events", (request, response) => {
  ...
  const insertQuery = "INSERT INTO events (name, place, date) VALUES (?, ?, ?)";

  const values = [newEvent.name, newEvent.place, newEvent.date];
...
app.get("/events/:id", (request, response) => {
  ...
  const selectQuery = "SELECT id, name, place, date from events WHERE id = ?";
...
app.get("/events", (request, response) => {
  ...
  const selectQuery = "SELECT id, name, place, date from events";
...
app.put("/entries", (request, response) => {
  ...
  const updatedSelected = updatedSelected.selected;
